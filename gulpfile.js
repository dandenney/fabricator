const assembler, assemble = require('fabricator-assemble');
...
const config = {
  ...
  styles: {
    ...
    package: {
      src: 'src/assets/toolkit/styles/core/**/',
      dest: 'package/core/scss',
    },
    toolkit: {
      src: 'src/assets/toolkit/styles/toolkit.scss',
      dest: 'dist/assets/toolkit/styles',
  ...
  scripts: {
    ...
    package: {
      src: 'src/assets/toolkit/scripts/core/**/',
      dest: 'package/core/js',
    },
    toolkit: {
      src: './src/assets/toolkit/scripts/toolkit.js',
      dest: 'dist/assets/toolkit/scripts',
...
gulp.task('styles:package', () => {
  gulp.src(config.styles.package.src)
    .pipe(gulp.dest(config.styles.package.dest))
});
...
gulp.task('styles', ['styles:fabricator', 'styles:package', 'styles:toolkit']);


// scripts
const webpackConfig = require('./webpack.config')(config);

gulp.task('scripts:package', () => {
  gulp.src(config.scripts.package.src)
    .pipe(gulp.dest(config.scripts.package.dest))
});
...
gulp.task('scripts', ['scripts:toolkit', 'scripts:package']);
...
// assemble from https://github.com/fbrctr/fabricator-assemble/pull/35
